...
<body class="bg-gray-300" style="font-family:Roboto">
    <div id="app">
        <main class="py-4">
            <nav :class="{'flex': open, 'hidden': !open}" class="flex-col flex-grow pb-4 md:pb-0 hidden md:flex md:justify-end md:flex-row" style="border-bottom: 1px solid #c0c0c0;">
                @guest
                    @if (Route::has('login'))
